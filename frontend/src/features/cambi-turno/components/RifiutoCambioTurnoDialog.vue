...
import type { CambioTurnoSubmitEmits, RifiutoCambioTurnoDialogProps } from '@/features/cambi-turno/types'
...
<template>
  <Dialog v-model:visible="visible" header="Motivo rifiuto" modal :style="dialogStyle.sm">
    <form class="form" @submit.prevent="emit('save')">
      ...
      <Button type="submit" label="Conferma rifiuto" severity="secondary" :loading="saving" />
    </form>
  </Dialog>
</template>
