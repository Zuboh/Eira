...
import type { NewPatientDialogProps, NewPatientForm, PatientDialogEmits } from '@/features/patients/types'
...
<template>
  <Dialog v-model:visible="visible" header="Nuovo paziente" modal :style="dialogStyle.md">
